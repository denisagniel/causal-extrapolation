...
# STUDY_DIR is referenced by R/dgp.R for its relative source path to the shared
# sims/scripts/dgp_helpers.R; set it BEFORE sourcing any study code below.
STUDY_DIR <- opt$study_dir
