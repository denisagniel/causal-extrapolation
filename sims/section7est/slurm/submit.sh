#!/bin/bash
# =============================================================================
# submit.sh -- submit the "section7est" study as chunked, throttled SLURM arrays
# =============================================================================
...
# section7est is self-contained: the DGP params + true FATT live in config/grid.R
# and R/dgp.R (which sources sims/scripts/dgp_helpers.R), so there are no staged
# .rds inputs to check.
REQUIRED_INPUTS=(
)
